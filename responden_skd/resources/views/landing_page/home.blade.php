...
@section('landing_page')
            ...
            <div class="row gx-5 align-items-center">
                <div class="col-xxl-5">
                    ...
                    <div class="text-center text-xxl-start">
                        <div class="badge bg-gradient-primary-to-secondary text-white mb-4 hidden">
                            <div class="text-uppercase">PST &middot; IPDS &middot; BPS</div>
                        </div>
                        <div class="fs-3 fw-light text-muted hidden">Merupakan proyek aplikasi berbasis web terintegrasi
                        </div>
                        <h1 class="display-3 fw-bolder mb-5 hidden"><span class="text-gradient d-inline">IPDS BPS Kota
                                Gunungsitoli</span></h1>
                        <div class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xxl-start mb-3 hidden">
                            {{-- <a class="btn btn-primary btn-lg px-5 py-3 me-sm-3 fs-6 fw-bolder" href="resume.html">Resume</a> --}}
                            <a class="btn btn-outline-dark btn-lg px-5 py-3 fs-6 fw-bolder"
                                href="{{ url('/projects') }}">Fitur Aplikasi Web</a>
                        </div>
                    </div>
                </div>
                <div class="col-xxl-7 hidden">
                    <!-- Header profile picture-->
                    <div class="d-flex justify-content-center mt-5 mt-xxl-0">
                        <div class="profile card shadow border-0">
                            <!-- TIP: For best results, use a photo with a transparent background like the demo example below-->
                            <!-- Watch a tutorial on how to do this on YouTube (link)-->
                            <img class="profile-img" src="{{ url('/assets') }}/img/lambang-bps.png" />
                            <div class="dots-2">
                                <!-- SVG Dots-->
    ...
    <!-- About Section-->
    <section class="bg-white py-5 hidden">
        <div class="container px-5">
            <div class="row gx-5 justify-content-center">
                <div class="col-xxl-8">
                    <div class="text-center my-5">
                        <h2 class="display-5 fw-bolder"><span class="text-gradient d-inline">About Us</span></h2>
                        <p class="lead fw-light mb-4"><q>Never Ending Improvement.</q></p>
                        <p class="text-muted">Terimakasih telah mengunjungi <i>website</i> kami. Jangan lupa juga untuk
                            mengunjungi <i>website</i> kantor kami melalui link <a href="https://gunungsitolikota.bps.go.id"
                                style="text-decoration: none;" target="_blank">gunungsitolikota.bps.go.id</a>, juga jangan lupa untuk
                            kunjungi akun media sosial kami yang tertera di bawah penjelasan ini. Terimakasih.</p>
